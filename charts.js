...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var resultArray = sampleData.filter(sampleObj => parseInt(sampleObj.id) == sample);
    ...
    var otuIdNames = otuId.map(id => `OTU ${id}`).slice(0,10).reverse();
